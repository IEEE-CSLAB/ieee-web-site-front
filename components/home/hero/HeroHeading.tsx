    ...
    return (
        <div className="absolute bottom-16 left-8 z-20 max-w-2xl text-white">
            ...
            <div className="flex items-center gap-4">
                <Link href="/contact" className="group flex items-center gap-2 bg-black text-white px-8 py-3 rounded-full font-medium hover:bg-gray-900 transition-all duration-300">
                    Bize Katılın
